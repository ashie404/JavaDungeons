...
public class PumpkinPasturesBlocks {
    ...
    public static final Block PM_BURNT_PUMPKIN = 
        RegistryHelper.registerBlock(new Block(FabricBlockSettings.create().strength(1.0F).sounds(BlockSoundGroup.WOOD)), "pm_burnt_pumpkin");
    public static final Block PM_ROTTED_PUMPKIN = 
        RegistryHelper.registerBlock(new Block(FabricBlockSettings.create().strength(1.0F).sounds(BlockSoundGroup.WOOD)), "pm_rotted_pumpkin");

    // haybale
    public static final Block PM_DRIED_HAYBALE = 
        RegistryHelper.registerBlock(new PillarBlock(FabricBlockSettings.create().strength(0.6F).sounds(BlockSoundGroup.GRASS)), "pm_dried_haybale");

    // ground related
    public static final Block PM_DIRT_SLAB = 
        RegistryHelper.registerBlock(new SlabBlock(FabricBlockSettings.create().strength(0.5F).sounds(BlockSoundGroup.GRAVEL)), "pm_dirt_slab");
    public static final Block PM_DIRT_PATH = 
        RegistryHelper.registerBlock(new DirtPathBlock(FabricBlockSettings.create().strength(0.5F).sounds(BlockSoundGroup.GRAVEL)), "pm_dirt_path");
    public static final Block PM_ROCKY_DIRT_PATH = 
        RegistryHelper.registerBlock(new DirtPathBlock(FabricBlockSettings.create().strength(0.5F).sounds(BlockSoundGroup.GRAVEL)), "pm_rocky_dirt_path");
    public static final Block PM_DIRT = 
        RegistryHelper.registerBlock(new PathableBlock(FabricBlockSettings.create().strength(0.5F).sounds(BlockSoundGroup.GRAVEL), true, PM_DIRT_PATH), "pm_dirt");
    public static final Block PM_ROCKY_DIRT = 
        RegistryHelper.registerBlock(new PathableBlock(FabricBlockSettings.create().strength(0.5F).sounds(BlockSoundGroup.GRAVEL), false, PM_ROCKY_DIRT_PATH), "pm_rocky_dirt");
    public static final Block PM_GRASS_BLOCK = 
        RegistryHelper.registerBlock(new GrassBlock(FabricBlockSettings.create().strength(0.6F).sounds(BlockSoundGroup.GRASS), true, Blocks.DIRT_PATH, PM_DIRT), "pm_grass_block");
    public static final Block PM_DENSE_GRASSY_DIRT = 
        RegistryHelper.registerBlock(new Block(FabricBlockSettings.create().strength(0.6F).sounds(BlockSoundGroup.GRASS)), "pm_dense_grassy_dirt");
    public static final Block PM_GRASSY_DIRT = 
        RegistryHelper.registerBlock(new Block(FabricBlockSettings.create().strength(0.5F).sounds(BlockSoundGroup.GRAVEL)), "pm_grassy_dirt");
    public static final Block PM_DARK_ROCKY_DIRT = 
        RegistryHelper.registerBlock(new Block(FabricBlockSettings.create().strength(0.5F).sounds(BlockSoundGroup.GRAVEL)), "pm_dark_rocky_dirt");
    public static final Block PM_CHARRED_GRASS_BLOCK = 
        RegistryHelper.registerBlock(new Block(FabricBlockSettings.create().strength(0.6F).sounds(BlockSoundGroup.GRASS)), "pm_charred_grass_block");
    public static final Block PM_CHARRED_DIRT_PATH = 
        RegistryHelper.registerBlock(new DirtPathBlock(FabricBlockSettings.create().strength(0.5F).sounds(BlockSoundGroup.GRAVEL)), "pm_charred_dirt_path");
    public static final Block PM_CHARRED_DIRT = 
        RegistryHelper.registerBlock(new PathableBlock(FabricBlockSettings.create().strength(0.5F).sounds(BlockSoundGroup.GRAVEL), false, PM_CHARRED_DIRT_PATH), "pm_charred_dirt");
    public static final Block PM_ASHY_DIRT = 
        RegistryHelper.registerBlock(new Block(FabricBlockSettings.create().strength(0.5F).sounds(BlockSoundGroup.GRAVEL)), "pm_ashy_dirt");
    public static final Block PM_CHARRED_DIRT_SLAB = 
        RegistryHelper.registerBlock(new SlabBlock(FabricBlockSettings.create().strength(0.5F).sounds(BlockSoundGroup.GRAVEL)), "pm_charred_dirt_slab");
    public static final Block PM_CHARRED_DIRT_EMBERS = 
        RegistryHelper.registerBlock(new Block(FabricBlockSettings.create().strength(0.5F).sounds(BlockSoundGroup.GRAVEL)), "pm_charred_dirt_embers");
    public static final Block PM_CHARRED_FARMLAND = 
        RegistryHelper.registerBlock(new DirtPathBlock(FabricBlockSettings.create().strength(0.5F).sounds(BlockSoundGroup.GRAVEL)), "pm_charred_farmland");

    // charred stones
    public static final Block PM_CHARRED_STONE = 
        RegistryHelper.registerBlock(new Block(FabricBlockSettings.create().strength(1.5F, 6.0F).sounds(BlockSoundGroup.STONE)), "pm_charred_stone");
    public static final SlabStairBlock PM_CHARRED_COBBLESTONE = 
        RegistryHelper.registerBSS(new SlabStairBlock(FabricBlockSettings.create().strength(1.5F, 6.0F).sounds(BlockSoundGroup.STONE)), "pm_charred_cobblestone");
    public static final SlabStairBlock PM_CHARRED_STONE_BRICKS = 
        RegistryHelper.registerBSS(new SlabStairBlock(FabricBlockSettings.create().strength(1.5F, 6.0F).sounds(BlockSoundGroup.STONE)), "pm_charred_stone_bricks", "pm_charred_stone_brick_slab", "pm_charred_stone_brick_stairs");
    public static final Block PM_CRACKED_CHARRED_STONE_BRICKS = 
        RegistryHelper.registerBlock(new Block(FabricBlockSettings.create().strength(1.5F, 6.0F).sounds(BlockSoundGroup.STONE)), "pm_cracked_charred_stone_bricks");

    // stone related
    public static final Block PM_MOSSY_STONE_BRICKS = 
        RegistryHelper.registerBlock(new Block(FabricBlockSettings.create().strength(1.5F, 6.0F).sounds(BlockSoundGroup.STONE)), "pm_mossy_stone_bricks");
    public static final Block PM_DIRTY_STONE = 
        RegistryHelper.registerBlock(new Block(FabricBlockSettings.create().strength(1.5F, 6.0F).sounds(BlockSoundGroup.STONE)), "pm_dirty_stone");
    public static final SlabStairBlock PM_DIRTY_STONE_TILES = 
        RegistryHelper.registerBSS(new SlabStairBlock(FabricBlockSettings.create().strength(1.5F, 6.0F).sounds(BlockSoundGroup.STONE)), "pm_dirty_stone_tiles");
    public static final SlabStairBlock PM_DIRTY_STONE_TILES_1 = 
        RegistryHelper.registerBSS(new SlabStairBlock(FabricBlockSettings.create().strength(1.5F, 6.0F).sounds(BlockSoundGroup.STONE)), "pm_dirty_stone_tiles_1", "pm_dirty_stone_tiles_slab_1", "pm_dirty_stone_tiles_stairs_1");
    public static final SlabStairBlock PM_DIRTY_STONE_TILES_2 = 
        RegistryHelper.registerBSS(new SlabStairBlock(FabricBlockSettings.create().strength(1.5F, 6.0F).sounds(BlockSoundGroup.STONE)), "pm_dirty_stone_tiles_2", "pm_dirty_stone_tiles_slab_2", "pm_dirty_stone_tiles_stairs_2");
    public static final Block PM_DIRTY_FLOOR_TILE = 
        RegistryHelper.registerBlock(new Block(FabricBlockSettings.create().strength(1.5F, 6.0F).sounds(BlockSoundGroup.STONE)), "pm_dirty_floor_tile");

    // wood related
    public static final Block PM_CHARRED_LOG = 
        RegistryHelper.registerBlock(new PillarBlock(FabricBlockSettings.create().strength(2.0F, 3.0F).sounds(BlockSoundGroup.WOOD)), "pm_charred_log");
    public static final Block PM_CHARRED_WOOD = 
        RegistryHelper.registerBlock(new PillarBlock(FabricBlockSettings.create().strength(2.0F, 3.0F).sounds(BlockSoundGroup.WOOD)), "pm_charred_wood");
    public static final SlabStairBlock PM_CHARRED_PLANKS = 
        RegistryHelper.registerBSS(new SlabStairBlock(FabricBlockSettings.create().strength(2.0F, 3.0F).sounds(BlockSoundGroup.WOOD)), "pm_charred_planks", "pm_charred_slab", "pm_charred_stairs");
