...
public class FieryForgeBlocks {
    ...
    public static final SlabStairBlock FF_DARK_STONE = 
        RegistryHelper.registerBSS(new SlabStairBlock(1.5F, 6.0F, BlockSoundGroup.STONE), "ff_dark_stone");
    public static final SlabStairBlock FF_DARK_COBBLESTONE = 
        RegistryHelper.registerBSS(new SlabStairBlock(1.5F, 6.0F, BlockSoundGroup.STONE), "ff_dark_cobblestone");
    public static final SlabStairBlock FF_DARK_STONE_BRICKS = 
        RegistryHelper.registerBSS(new SlabStairBlock(1.5F, 6.0F, BlockSoundGroup.STONE), "ff_dark_stone_bricks", "ff_dark_stone_brick_slab", "ff_dark_stone_brick_stairs");
    public static final Block FF_DIRTY_DARK_STONE_BRICKS = 
        RegistryHelper.registerBlock(new BaseBlock(1.5F, 6.0F, BlockSoundGroup.STONE), "ff_dirty_dark_stone_bricks");
    public static final Block FF_CRACKED_DARK_STONE_BRICKS = 
        RegistryHelper.registerBlock(new BaseBlock(1.5F, 6.0F, BlockSoundGroup.STONE), "ff_cracked_dark_stone_bricks");
    public static final Block FF_CHISELED_DARK_STONE_BRICKS = 
        RegistryHelper.registerBlock(new BaseBlock(1.5F, 6.0F, BlockSoundGroup.STONE), "ff_chiseled_dark_stone_bricks");
    public static final SlabStairBlock FF_DARK_STONE_TILES = 
        RegistryHelper.registerBSS(new SlabStairBlock(1.5F, 6.0F, BlockSoundGroup.STONE), "ff_dark_stone_tiles");
    public static final SlabStairBlock FF_DIRTY_DARK_STONE_TILES = 
        RegistryHelper.registerBSS(new SlabStairBlock(1.5F, 6.0F, BlockSoundGroup.STONE), "ff_dirty_dark_stone_tiles");
    public static final SlabStairBlock FF_DIRTY_DARK_STONE_TILES_1 = 
        RegistryHelper.registerBSS(new SlabStairBlock(1.5F, 6.0F, BlockSoundGroup.STONE), "ff_dirty_dark_stone_tiles_1", "ff_dirty_dark_stone_tiles_slab_1", "ff_dirty_dark_stone_tiles_stairs_1");
    public static final Block FF_EMBLEMED_DARK_STONE = 
        RegistryHelper.registerBlock(new BaseBlock(1.5F, 6.0F, BlockSoundGroup.STONE), "ff_emblemed_dark_stone");
