...
public class DingyJungleBlocks {
    ...
    public static final Block DJ_GRASS_BLOCK = 
        RegistryHelper.registerBlock(new BaseBlock(0.6F, 0.6F, BlockSoundGroup.GRASS), "dj_grass_block");
    public static final Block DJ_MUDDY_GRASS =
        RegistryHelper.registerBlock(new BaseBlock(0.6F, 0.6F, BlockSoundGroup.GRASS), "dj_muddy_grass");
    public static final Block DJ_DIRT =
        RegistryHelper.registerBlock(new BaseBlock(0.5F, 0.5F, BlockSoundGroup.GRAVEL), "dj_dirt");
    public static final Block DJ_DIRTY_MUD =
        RegistryHelper.registerBlock(new BaseBlock(0.5F, 0.5F, BlockSoundGroup.GRAVEL), "dj_dirty_mud");
    public static final Block DJ_MUD =
        RegistryHelper.registerBlock(new BaseBlock(0.5F, 0.5F, BlockSoundGroup.GRAVEL), "dj_mud");
    public static final Block DJ_GRASSY_DIRT =
        RegistryHelper.registerBlock(new BaseBlock(0.5F, 0.5F, BlockSoundGroup.GRAVEL), "dj_grassy_dirt");
    public static final Block DJ_GRASSY_MUD =
        RegistryHelper.registerBlock(new BaseBlock(0.5F, 0.5F, BlockSoundGroup.GRAVEL), "dj_grassy_mud");
    public static final Block DJ_DENSE_GRASSY_MUD =
        RegistryHelper.registerBlock(new BaseBlock(0.6F, 0.6F, BlockSoundGroup.GRASS), "dj_dense_grassy_mud");
    public static final Block DJ_ROCKY_DIRT =
        RegistryHelper.registerBlock(new BaseBlock(0.5F, 0.5F, BlockSoundGroup.GRAVEL), "dj_rocky_dirt");
    
    // pebbles
    public static final Block DJ_PEBBLES =
        RegistryHelper.registerBlock(new BaseBlock(1.5F, 6.0F, BlockSoundGroup.STONE), "dj_pebbles");
    public static final Block DJ_DIRTY_PEBBLES =
        RegistryHelper.registerBlock(new BaseBlock(1.5F, 6.0F, BlockSoundGroup.STONE), "dj_dirty_pebbles");
    public static final Block DJ_GRASSY_PEBBLES =
        RegistryHelper.registerBlock(new BaseBlock(1.5F, 6.0F, BlockSoundGroup.STONE), "dj_grassy_pebbles");
    
    // stones
    public static final Block DJ_OCELOT_STONE =
        RegistryHelper.registerBlock(new BaseBlock(1.5F, 6.0F, BlockSoundGroup.STONE), "dj_ocelot_stone");
    public static final Block DJ_CHISELED_STONE =
        RegistryHelper.registerBlock(new BaseBlock(1.5F, 6.0F, BlockSoundGroup.STONE), "dj_chiseled_stone");
    public static final Block DJ_DINGY_CHISELED_STONE =
        RegistryHelper.registerBlock(new BaseBlock(1.5F, 6.0F, BlockSoundGroup.STONE), "dj_dingy_chiseled_stone");
    public static final Block DJ_MOSSY_CHISELED_STONE =
        RegistryHelper.registerBlock(new BaseBlock(1.5F, 6.0F, BlockSoundGroup.STONE), "dj_mossy_chiseled_stone");
    ...
    public static final Block DJ_BRICKS = 
        RegistryHelper.registerBlock(new BaseBlock(2.0F, 6.0F, BlockSoundGroup.STONE), "dj_bricks");
    public static final Block DJ_SLIGHTLY_MOSSY_BRICKS =
        RegistryHelper.registerBlock(new BaseBlock(2.0F, 6.0F, BlockSoundGroup.STONE), "dj_slightly_mossy_bricks");
    public static final Block DJ_MOSSY_BRICKS =
        RegistryHelper.registerBlock(new BaseBlock(2.0F, 6.0F, BlockSoundGroup.STONE), "dj_mossy_bricks");
    public static final Block DJ_LARGE_BRICKS =
        RegistryHelper.registerBlock(new BaseBlock(2.0F, 6.0F, BlockSoundGroup.STONE), "dj_large_bricks");
    
    // stone floors
    public static final Block DJ_BLUE_GLAZED_STONE_FLOOR =
        RegistryHelper.registerBlock(new BaseBlock(2.0F, 6.0F, BlockSoundGroup.STONE), "dj_blue_glazed_stone_floor");
    public static final Block DJ_DIRTY_BLUE_GLAZED_STONE_FLOOR =
        RegistryHelper.registerBlock(new BaseBlock(2.0F, 6.0F, BlockSoundGroup.STONE), "dj_dirty_blue_glazed_stone_floor");
    public static final Block DJ_YELLOW_GLAZED_STONE_FLOOR =
        RegistryHelper.registerBlock(new BaseBlock(2.0F, 6.0F, BlockSoundGroup.STONE), "dj_yellow_glazed_stone_floor");
    
    // tiles
    public static final Block DJ_TILE =
        RegistryHelper.registerBlock(new BaseBlock(2.0F, 6.0F, BlockSoundGroup.STONE), "dj_tile");
    public static final Block DJ_CRACKED_TILE =
        RegistryHelper.registerBlock(new BaseBlock(2.0F, 6.0F, BlockSoundGroup.STONE), "dj_cracked_tile");
    public static final Block DJ_GOLD_EMBEDDED_TILE =
        RegistryHelper.registerBlock(new BaseBlock(2.0F, 6.0F, BlockSoundGroup.STONE), "dj_gold_embedded_tile");
    
    // plants
    public static final Block DJ_GRASS =
        RegistryHelper.registerBlock(new Plant(0.0F, 0.0F, BlockSoundGroup.GRASS), "dj_grass");
    public static final Block DJ_RED_FERN =
        RegistryHelper.registerBlock(new Plant(0.0F, 0.0F, BlockSoundGroup.GRASS), "dj_red_fern");
    public static final Block DJ_TALL_FERN =
        RegistryHelper.registerBlock(new TallPlant(0.0F, 0.0F, BlockSoundGroup.GRASS), "dj_tall_fern");
    public static final Block DJ_TALL_GRASS =
        RegistryHelper.registerBlock(new TallPlant(0.0F, 0.0F, BlockSoundGroup.GRASS), "dj_tall_grass");
    public static final Block DJ_SHRUB =
        RegistryHelper.registerBlock(new Plant(0.0F, 0.0F, BlockSoundGroup.GRASS), "dj_shrub");
    public static final Block DJ_DEAD_SHRUB =
        RegistryHelper.registerBlock(new Plant(0.0F, 0.0F, BlockSoundGroup.GRASS), "dj_dead_shrub");
    public static final Block DJ_BUSH =
        RegistryHelper.registerBlock(new Plant(0.0F, 0.0F, BlockSoundGroup.GRASS), "dj_bush");
    public static final Block DJ_LARGE_JUNGLE_PLANT =
        RegistryHelper.registerBlock(new JunglePlant(0.0F, 0.0F, BlockSoundGroup.GRASS), "dj_large_jungle_plant");
    public static final Block DJ_LARGE_JUNGLE_FERN =
        RegistryHelper.registerBlock(new JunglePlant(0.0F, 0.0F, BlockSoundGroup.GRASS), "dj_large_jungle_fern");
    public static final Block DJ_FLOWERING_JUNGLE_PLANT =
        RegistryHelper.registerBlock(new JunglePlant(0.0F, 0.0F, BlockSoundGroup.GRASS), "dj_flowering_jungle_plant");
    public static final Block DJ_LARGE_JUNGLE_FLOWER =
        RegistryHelper.registerBlock(new JunglePlant(0.0F, 0.0F, BlockSoundGroup.GRASS), "dj_large_jungle_flower");
    
    // custom dingy jungle wood & leaves
    public static final Block DJ_JUNGLE_LOG =
        RegistryHelper.registerBlock(new Pillar(2.0F, 2.0F, BlockSoundGroup.WOOD), "dj_jungle_log");
    public static final Block DJ_JUNGLE_LEAVES =
        RegistryHelper.registerBlock(new Leaves(0.0F, 0.0F, BlockSoundGroup.GRASS), "dj_jungle_leaves");
