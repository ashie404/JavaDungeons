...
public class JungleGlowMushroomFeature extends Feature<CountConfig> {
    public JungleGlowMushroomFeature(Codec<CountConfig> codec) {
        super(codec);
    }
    ...
    public boolean generate(FeatureContext<CountConfig> context) {
        ...
        for(int k = 0; k < j; ++k) {
            ...
            BlockState blockState = DingyJungleBlocks.DJ_GLOW_MUSHROOM.getDefaultState()
