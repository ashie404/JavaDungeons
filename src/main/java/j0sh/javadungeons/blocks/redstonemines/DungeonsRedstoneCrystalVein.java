...
public class DungeonsRedstoneCrystalVein extends RedstoneBlock {
    ...
    public DungeonsRedstoneCrystalVein(Block base, Boolean byHand, Tag<Item> tool, ItemGroup group, int power, int lightLevel, String id) {
    ...
    static {
        ...
        MAIN_CRYSTAL_X = Block.createCuboidShape(6.0D, 0.0D, 6.0D, 15.0D, 7.0D, 15.0D);
        MAIN_CRYSTAL_Z = Block.createCuboidShape(6.0D, 0.0D, 1.0D, 15.0D, 7.0D, 10.0D);
        CRYSTAL_X = VoxelShapes.union(MAIN_CRYSTAL_X);
        CRYSTAL_Z = VoxelShapes.union(MAIN_CRYSTAL_Z);
    }
}
