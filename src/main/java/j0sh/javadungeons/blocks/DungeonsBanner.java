...
public class DungeonsBanner extends Block {
    ...
    public DungeonsBanner(Material material, BlockSoundGroup sounds, ItemGroup group, String id) {
        super(FabricBlockSettings.of(material).sounds(sounds).collidable(false));
