...
public class DungeonsGlowMushroom extends SeaPickleBlock {
    ...
    public DungeonsGlowMushroom(Material material, BlockSoundGroup sounds, Boolean byHand, Tag<Item> tool, ItemGroup group, String id) {
        super(FabricBlockSettings.of(material).sounds(sounds).breakByHand(byHand).breakByTool(tool).collidable(false).lightLevel(12));
