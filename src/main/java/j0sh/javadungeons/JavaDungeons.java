...
public class JavaDungeons implements ModInitializer {
	...
	public static final ItemGroup REDSTONE_MINES = FabricItemGroupBuilder.build(new Identifier(MOD_ID, "redstone_mines"), () -> new ItemStack(GenericBlocks.GREEN_LIT_BRAZIER));
	public static final ItemGroup FIERY_FORGE = FabricItemGroupBuilder.build(new Identifier(MOD_ID, "fiery_forge"), () -> new ItemStack(GenericBlocks.GREEN_LIT_BRAZIER));
