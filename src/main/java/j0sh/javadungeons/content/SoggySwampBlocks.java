...
public class SoggySwampBlocks {
    ...
    public static void init() {
        ...
        SS_DIRT_PATH = new DungeonsPath(Material.SOIL, 0.5F, 0.5F, BlockSoundGroup.GRAVEL, JavaDungeons.SOGGY_SWAMP, "ss_dirt_path");
        SS_DIRT = new DungeonsPathable(Material.SOIL, 0.5F, 0.5F, BlockSoundGroup.GRAVEL, SS_DIRT_PATH, JavaDungeons.SOGGY_SWAMP, "ss_dirt");
