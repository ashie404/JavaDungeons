...
public class DesertTempleBlocks {
    ...
    public static void init() {
        ...
        DT_CHISELED_SANDY_ANDESITE = new DungeonsBlock(Material.STONE, BlockSoundGroup.STONE,false, FabricToolTags.PICKAXES, JavaDungeons.DESERT_TEMPLE, "dt_chiseled_sandy_andesite");
        DT_CHISELED_SANDY_ANDESITE_2 = new DungeonsBlock(Material.STONE, BlockSoundGroup.STONE,false, FabricToolTags.PICKAXES, JavaDungeons.DESERT_TEMPLE, "dt_chiseled_sandy_andesite_2");
        DT_SANDY_ANDESITE_PILLAR = new DungeonsPillar(Material.STONE, BlockSoundGroup.STONE,false, FabricToolTags.PICKAXES, JavaDungeons.DESERT_TEMPLE, "dt_sandy_andesite_pillar");
        ...
        DT_CRACKED_SANDY_STONE_BRICKS = new DungeonsBlock(Material.STONE, BlockSoundGroup.STONE,false, FabricToolTags.PICKAXES, JavaDungeons.DESERT_TEMPLE, "dt_cracked_sandy_stone_bricks");
        ...
        DT_CHISELED_SANDY_STONE = new DungeonsBlock(Material.STONE, BlockSoundGroup.STONE,false, FabricToolTags.PICKAXES, JavaDungeons.DESERT_TEMPLE, "dt_chiseled_sandy_stone");

        // stone related
        DT_SANDY_COBBLESTONE = new DungeonsBlock(Material.STONE, BlockSoundGroup.STONE,false, FabricToolTags.PICKAXES, JavaDungeons.DESERT_TEMPLE, "dt_sandy_cobblestone");
    }
}