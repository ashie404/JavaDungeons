...
public class DDRContainer extends ScreenHandler {
   ...
   public DDRContainer(final int syncId, final PlayerInventory playerInventory, final ScreenHandlerContext blockContext) {
      super(null, syncId);
   ...
   private void populateResult() {
      if (!this.availableRecipes.isEmpty()) {
         final DDRRecipe DDRRecipe = this.availableRecipes.get(this.selectedRecipe.get());
   ...
   public void close(final PlayerEntity player) {
      super.close(player);
      this.field_19173.removeStack(1);
